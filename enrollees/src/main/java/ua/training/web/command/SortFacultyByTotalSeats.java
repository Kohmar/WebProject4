 ...
 */
public class SortFacultyByTotalSeats extends Command {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4188559635484312000L;
	
	private static final Logger LOG = Logger.getLogger(SortFacultyByTotalSeats.class);
	
	private static final Comparator<FacultyDto> SORT_FACULTY_BY_TOTAL_SEATS = new Comparator<FacultyDto>() {
		@Override
